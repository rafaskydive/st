 ...
 */
static char *font = "FiraMono Nerd Font:pixelsize=14:antialias=true:autohint=true";
static char *font2[] = { "FiraMono Nerd Font:pixelsize=10:antialias=true:autohint=true" };
